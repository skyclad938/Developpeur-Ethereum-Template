...
// We firt check that our smart contract can be deployed correctly
...
// We'll do some unitary tests with function and WorkflowStatus
...
// we check that only owner can modify workflow status to open Proposal
          it("should owner only to change status StartProposal", async () => {
...
// we check that only owner can modify workflow status to close proposal
          it("should owner only to change status EndProposal", async () => {
...
// we check that only owner can modify workflow status to open voting session
          it("should owner only to change status StartVoting Session", async () => {
...
// we check that only owner can modify workflow status to close voting session
          it("should owner only to change status EndVoting Session", async () => {
